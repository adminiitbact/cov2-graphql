...
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER "set_public_patient_history_updated_at"
BEFORE UPDATE ON "public"."patient_history"
FOR EACH ROW
EXECUTE PROCEDURE "public"."set_current_timestamp_updated_at"();
COMMENT ON TRIGGER "set_public_patient_history_updated_at" ON "public"."patient_history" 
